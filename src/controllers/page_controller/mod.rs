...
pub use admin::{
    ...
    admin_login_page, admin_login_submit, admin_index, admin_logout,
    users_list, users_datatable_api, user_create_page, user_create_submit,
    user_detail, user_edit_page, user_edit_submit, user_delete,
};
pub use public::{
    index, login_page, login_submit, register_page, register_submit, logout,
    update_password_page, update_password_submit, handle_404,
};
